...
public class EmployeeDAOImpl implements IEmployeeDAO {
	...
	public void save(Employee e) {
		jdbcTemplate.update("INSERT INTO employee (username,password,age,hiredate) VALUES (?,?,?,?)", e.getUsername(), e.getPassword(),
				e.getAge(), e.getHiredate());
	}

	public void update(Employee e) {
		jdbcTemplate.update("UPDATE employee SET username= ?,password=?,age = ?,hiredate=? WHERE id= ?", e.getUsername(), e.getPassword(),
	...
	public List<Employee> listAll() {
		return jdbcTemplate.query("SELECT id,username,password,age,hiredate FROM employee", new Object[] {}, (rs, rowNum) -> {
			Employee e = new Employee();
			e.setId(rs.getLong("id"));
			e.setUsername(rs.getString("username"));
			e.setPassword(rs.getString("password"));
